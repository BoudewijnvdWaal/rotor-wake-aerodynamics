...
def main():
    ...
    CT = 0.75
    CP = executeBEM(U0, TSR[1], RootLocation_R, TipLocation_R,
        Omega[1], Radius, blades, r_R, chord_distribution, twist_distribution, polar_alpha, polar_cl, polar_cd)


    if visualise == True:
        plt.figure(figsize=(12,6))
        plt.plot(CT, CP, 'ro-', label='BEM results')
